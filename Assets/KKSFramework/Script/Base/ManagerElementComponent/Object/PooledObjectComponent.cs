...
namespace KKSFramework.ResourcesLoad
{
    ...
    public class PooledObjectComponent : PrefabComponent
    {
        ...
        /// 오브젝트가 생성됨.
        /// </summary>
        public T Created<T>(string poolingPath) where T : PooledObjectComponent
        {
            gameObject.SetActive(true);
            PoolingInfo = new PoolingInfo(poolingPath);
            OnCreated();
        ...
        /// 오브젝트가 생성됨.
        /// </summary>
        public T Created<T>(Transform parents, string poolingPath) where T : PooledObjectComponent
        {
