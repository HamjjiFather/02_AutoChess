...
namespace Tests
{
    public class TestUIdIssuancer : IUniqueIndexIssuancer
    {
        public int UniqueIndex { get; set; } = UniqueIndexDefine.BaseEquipmentUniqueIndex;

        public int GetUniqueIndex() => UniqueIndex++;
    }
