...
namespace AutoChess.Domain
{
    ...
    /// 아이템의 가장 기본 클래스.
    /// </summary>
    public class ItemModelBase : IItem
    {
        ...
        public ItemModelBase(int uniqueIndex, string itemIndex, int itemAmount)
        {
    ...
    /// 보관된 아이템 데이터.
    /// </summary>
    public class StoredItemModelBase : ItemModelBase
    {
        public StoredItemModelBase(int uniqueIndex, string itemIndex, int itemAmount) : 
