...
#pragma warning restore CS0649
        ...
        // public string ToSkillDescriptionString (CharacterModelBase characterBase)
        // {
        //     // var originDesc = LocalizeHelper.FromDescription (characterBase.SkillData.Desc);
        //     //
        //     // if (originDesc == null || !originDesc.Contains ("#VALUE")) return characterBase.SkillData.Desc;
        //     //
        //     // var valueString = ToValueString (characterBase, characterBase.SkillData);
        ...
        /// ex) 50 + 25 (0.5 공격력)
        /// </summary>
        private string ToValueString (CharacterModelBase characterBase, CharacterSkill skillData)
        {
            return string.Empty;
