...
#pragma warning restore CS0649
        ...
        public override void InitFinally()
        {
            ...
            characterBundle.CharacterUniqueIds.Foreach ((uid, arrayIndex) =>
            {
                ...
                var attackData = TableDataManager.Instance.CharacterSkillDict[characterTable.AttackIndex];
                var skillData = TableDataManager.Instance.CharacterSkillDict[characterTable.SkillIndex];
        ...
        public void AddCharacterExps (int exp)
        {
            BattleCharacterModels.Foreach ((model, index) =>
            {
                ...
                var statusGrade = model.PrimeAbility;
        ...
        public CharacterData NewCharacter (int characterIndex, List<CharacterData> modelDatas)
        {
            ...
            CharacterPrimeAbility NewStatusGradeValue ()
            {
                return new CharacterPrimeAbility (0, 0, 0);
            }
